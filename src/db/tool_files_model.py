...
class ToolFileModel(Base):
    ...
    tool_id = Column(CHAR(36), ForeignKey('tool_class.id'), nullable=False, comment='关联工具ID')
    file_url = Column(String(512), unique=True, nullable=False, comment='文件存储路径')  # 设置唯一键
