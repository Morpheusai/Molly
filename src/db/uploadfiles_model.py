...
class UploadedFile(Base):
    ...
    conversation_id = Column(CHAR(36), ForeignKey(
        'conversation.id'), nullable=False, comment='会话ID')
    ...
    # 通常SHA256是64个字符
    file_hash = Column(String(64), comment='文件内容哈希值，用于比较文件内容是否相同')
