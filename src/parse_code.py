...
code_knowledge_base = CodeKnowledgeBase(
    kb_config=g_config["knowledge_base"], llm_config=g_config["llm"]["code_parser"])
...
instance_list = code_knowledge_base.retrieve_docs(
    query_content="代码执行过程中出现了错误，具体是由于配置文件中缺少 'work_dir' 参数导致的 KeyError", project_name=None)
